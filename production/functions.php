<?php
 ...
 function update_datosn($nempleado,$periodo,$incentivo1,$incentivo2,$incentivo3,$incentivo4,$perac,$semc,$sema){
  ...
  $dias = array("domingo","lunes","martes","miercoles","jueves","viernes","sabado");
	...
	$ckey1 = $nempleado.$an.$peractual."-1";
	...
	$sql_s = odbc_exec($conexion, $sentenciac);
		   if(odbc_fetch_row($sql_s))
		    ...
		    //echo "Entro aqui primero".$ckey1;
			  ...
			  $sentenciau = "UPDATE usuarionom set is1='$incentivo1'  where ucfdi='$nempleado'".$sql;
			  $ejecutar = odbc_exec($conexion, $sentenciau); //mysqli_query($conexion,$sentencia);
			   $res ="existe";
			 }
			else
			 {
			  $semperiodo = "1";
			  $semact1b = $an.$peractual."-1";
	...
	$ckey2 = $nempleado.$an.$peractual."-2";	
		   ...
		   if(odbc_fetch_row($sql_s))
			 {
			  ...
			  $sentenciau = "UPDATE usuarionom set is2='$incentivo2'  where ucfdi='$nempleado'".$sql;
			  $ejecutar = odbc_exec($conexion, $sentenciau); //mysqli_query($conexion,$sentencia);
	...
	$ckey3 = $nempleado.$an.$peractual."-3";
		   ...
		   if(odbc_fetch_row($sql_s))
			 {
			  ...
			  $sentenciau = "UPDATE usuarionom set is3='$incentivo3'  where ucfdi='$nempleado'".$sql;
			  $ejecutar = odbc_exec($conexion, $sentenciau); //mysqli_query($conexion,$sentencia);
	...
	$ckey4 = $nempleado.$an.$peractual."-4";	
		   ...
		   if(odbc_fetch_row($sql_s))
			 {
			  ...
			  $ejecutar = odbc_exec($conexion, $sentencia); //mysqli_query($conexion,$sentencia);
			  $sentenciau = "UPDATE usuarionom set is4='$incentivo4'  where ucfdi='$nempleado'".$sql;
			  $ejecutar = odbc_exec($conexion, $sentenciau); //mysqli_query($conexion,$sentencia);
